...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      {/* HERO */}
      <section className="bg-gradient-to-b from-amber-950/30 to-neutral-950 py-16">
        <div className="mx-auto max-w-6xl px-6 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">About This Gala</h1>
          <p className="text-xl text-neutral-300">Experience elegance, luxury, and unforgettable celebration</p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <div className="space-y-12">
          {/* A NIGHT OF ELEGANCE */}
          <div>
            <h2 className="text-3xl font-bold text-amber-400 mb-4">🎉 A Night of Elegance & Arabic Spirit</h2>
          ...
          <Card className="bg-neutral-900/50 border-amber-500/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-amber-400 mb-4">✨ The Venue</h3>
              <p className="text-neutral-300 leading-relaxed">
          ...
          <Card className="bg-neutral-900/50 border-amber-500/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-amber-400 mb-4">🍽️ Luxury Gala Dinner by Hilton</h3>
              <p className="text-neutral-300 leading-relaxed">
          ...
          <Card className="bg-neutral-900/50 border-amber-500/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-amber-400 mb-4">🎤 World-Class Entertainment</h3>
              <p className="text-neutral-300 leading-relaxed">
          ...
          <Card className="bg-neutral-900/50 border-amber-500/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-amber-400 mb-4">📋 How to Reserve Your Position</h3>
          ...
          {/* ULTIMATE EXPERIENCE */}
          <div className="bg-gradient-to-r from-amber-950/20 to-neutral-900 rounded-lg p-8 border border-amber-500/20">
            <h3 className="text-3xl font-bold text-amber-400 mb-6">The Ultimate New Year's Eve Gala Experience</h3>
          ...
          <Card className="bg-neutral-900/50 border-amber-500/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-amber-400 mb-4">👑 VIP Experience</h3>
          ...
          <Card className="bg-neutral-900/50 border-amber-500/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-amber-400 mb-4">🎯 Professional Organization</h3>
              <p className="text-neutral-300 mb-4 leading-relaxed">
          ...
          <Card className="bg-neutral-900/50 border-amber-500/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-amber-400 mb-4">🔒 Technology & Security</h3>
              <p className="text-neutral-300 mb-4 leading-relaxed">
          ...
          <Card className="bg-neutral-900/50 border-amber-500/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-amber-400 mb-4">👔 Dress Code & Atmosphere</h3>
              <p className="text-neutral-300 mb-4 leading-relaxed">
          ...
          <Card className="bg-neutral-900/50 border-amber-500/20">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold text-amber-400 mb-4">🤝 Transparency & Trust</h3>
              <p className="text-neutral-300 mb-4 leading-relaxed">
          ...
          {/* EVENT ORGANIZER */}
          <Card className="bg-gradient-to-r from-amber-950/30 to-neutral-900 border-amber-500/40">
            <CardContent className="p-8 text-center">
              <h3 className="text-3xl font-bold text-amber-400 mb-4">🎯 Event Organizer</h3>
          ...
          <div className="text-center py-8">
            <h3 className="text-2xl font-bold text-amber-400 mb-4">✨ A Celebration Worth Remembering</h3>
