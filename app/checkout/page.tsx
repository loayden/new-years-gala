...
export default function CheckoutPage() {
  ...
  const handleCheckout = () => {
    if (!name || !email || !selectedTicket) {
      alert("Please fill in all fields and select a ticket")
      return
    }
    // TODO: Integrate with Stripe/payment gateway
    alert(`Processing payment of $${total.toFixed(2)} for ${name}`)
  }
  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <main className="mx-auto max-w-6xl px-6 py-12">
              ...
              <CardContent className="p-6">
                ...
                {ticket ? (
                  <>
                    ...
                    {/* PAYMENT BUTTON */}
                    <Button onClick={handleCheckout} className="w-full bg-amber-500 hover:bg-amber-600 text-black font-bold text-lg py-3">
        ...
        {/* PAYMENT METHODS */}
        <Card className="mt-8 bg-neutral-900/50 border-neutral-700">
          <CardContent className="p-6">
            <h3 className="font-bold text-lg mb-4">Payment Methods</h3>
            <div className="grid gap-4 md:grid-cols-4">
              <div className="flex items-center justify-center p-4 border border-neutral-700 rounded-lg hover:border-amber-500/50 cursor-pointer transition">
        ...
        <Card className="mt-8 bg-neutral-900/50 border-neutral-700">
          <CardContent className="p-6">
            <h3 className="font-bold text-lg mb-4">Secure Checkout</h3>
            <ul className="space-y-3 text-sm text-neutral-400">
              ...
              <li className="flex items-start gap-3">
                <span className="text-amber-400 font-bold">✓</span>
                <span>You'll receive a confirmation email with your tickets immediately</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-amber-400 font-bold">✓</span>
                <span>Tickets are non-refundable but transferable to another person</span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-amber-400 font-bold">✓</span>
                <span>QR codes will be sent to your email for event entry</span>
              </li>
            </ul>
          </CardContent>
        </Card>
